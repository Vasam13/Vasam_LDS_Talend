...
java -cp ${MODULE_JAR_FILE} alation.${MODULE}.Main MAKE_MANIFEST
...
connectorName="alation-${MODULE}"

echo " Step 4: Building docker image..."
docker build -t ${connectorName} --build-arg module_jar_file=${MODULE_JAR_FILE} -f $DOCKER_FILE .
